...
var Projects = function Projects() {
  var makeCard = function makeCard() {
    ...
    var values = _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(_data_storage_database__WEBPACK_IMPORTED_MODULE_4__["default"]); // const entries = Object.entries(database); // Return array of key-value pairs


    var arr = []; // keys.forEach(key => {
    //   arr.push(database[key]);
    // });

    console.log(values); // let ul = document.querySelector('.card');
...
//# sourceMappingURL=index.js.e5b19c2492c121f21c1b.hot-update.js.map