...
var Resume = function Resume() {
  ...
  var renderGithubLink = function renderGithubLink() {
    switch (expType) {
      case "professional":
        return "";
      ...
      case "project":
        return __jsx("a", {
          href: values[3].project[0].link[1],
          __self: _this,
          __source: {
  ...
  var renderExperience = function renderExperience(expType) {
    return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("h3", {
      ...
      }, exp.title, locationExist, renderGithubLink), __jsx("p", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a.dynamic([["3796647623", [values[9].highlight]]]),
        __self: _this,
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=resume.js.6615a72d0228a105d4cf.hot-update.js.map